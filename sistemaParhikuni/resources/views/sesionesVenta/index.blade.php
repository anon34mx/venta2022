...
<div class="col-12 col-sm-11 col-md-11 col-lg-11 mx-auto">
    <h3>Sesiones de venta {{ @$corridaDisponible->nNumero }}</h3>
    @if(!session()->has("sesionVenta"))
        <a href="{{route('sesionesventa.store')}}" class="btn btn-parhi-primary my-3">
            Abrir nueva sesión de venta
        </a>
    @endif
    <div>
    ...
    <div class="mt-3 d-flex justify-content-center">
        {!! $sesiones->appends(Request::all())->links("pagination::bootstrap-5") !!}
    </div>
</div>
@endsection